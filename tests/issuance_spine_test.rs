...
/// Per-process fixture sequence shared by every fixture builder: tests run
/// in parallel within one process and the fake clock is frozen, so a shared
/// counter is what keeps each fixture's key-store directory distinct.
